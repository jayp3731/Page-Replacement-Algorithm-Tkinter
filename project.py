...
def algo():
    ...
    canvas=Canvas(top,width=1153,height=768)
    top.title('Algorithm')
    my_img = ImageTk.PhotoImage(Image.open("C:\\Users\\jay\\Desktop\\op project\\Simpager-master\\1.png"))
    ...
    myButton2 = Button(top, text="LFU", bg="ORANGE2", width=10, height=1, command=LFU1, font="comicsansms",
                       borderwidth=5)
...
myButton = Button(root, text="algorithm",bg="ORANGE2", width=10, height=1, command=algo, font="comicsansms",borderwidth=5)
myButton.place( x=250, y=200 )

myButton = Button(root, text="advance",bg="ORANGE2", width=10, height=1, command=adva, font="comicsansms",borderwidth=5)
